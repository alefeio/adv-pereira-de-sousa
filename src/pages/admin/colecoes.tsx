          ...
          <section className="bg-white p-8 rounded-xl shadow-lg mb-10 border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-6">
                <button type="submit" disabled={loading} className="bg-primary text-white p-4 rounded-lg flex-1 font-bold shadow-md hover:bg-primary transition duration-200 disabled:bg-white">
