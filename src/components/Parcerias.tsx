...
export default function Parcerias() {
    return (
        <section
            id="parcerias"
            className="relative z-20 bg-black min-h-[100vh] bg-cover bg-center bg-no-repeat"
            style={{ backgroundImage: 'url(/images/maos-apertando.jpg)' }}
        >
            {/* Overlay escuro para legibilidade do texto */}
            <div className="absolute inset-0 bg-black/75 z-0" aria-hidden="true" />
